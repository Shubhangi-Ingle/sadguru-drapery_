    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-3">
              <img src="/logo.png" alt="Sadguru Drapery" className="h-10 w-10 object-contain" />
              <span className="font-brand text-lg font-bold text-white">Sadguru Drapery</span>
            </div>
            <p className="text-sm text-gray-400 leading-relaxed">
              Costume rentals for dance, festive occasions, kids' fancy dress, and photoshoots — trusted
              across Pune for over 13 years.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link to="/visit-us" className="hover:text-pink-400 transition-colors">Visit Us</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-gray-400">
              <li className="leading-relaxed">
                Woodsville St, near Nikhil Borade office, Borade Vasti, Moshi, Pimpri-Chinchwad, Maharashtra 411070
              </li>
              <li>
              ...
              <li>10:00 AM – 8:00 PM, all days</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-10 h-10 rounded-full bg-gray-800 hover:bg-pink-600 flex items-center justify-center text-gray-300 hover:text-white transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-800 hover:bg-green-600 flex items-center justify-center text-gray-300 hover:text-white transition-colors"
                aria-label="WhatsApp"
              >
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500">
          <p>&copy; {new Date().getFullYear()} Sadguru Drapery. All rights reserved.</p>
