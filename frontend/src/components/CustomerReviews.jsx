...
const reviews = [
  {
    ...
    initials: 'PS',
    rating: 5,
    text: 'Rented a costume for my daughter\'s Bharatanatyam recital and it was even better than the photos. Quick delivery too!',
  },
  {
    name: 'Meera Iyer, St. Xavier\'s School',
    initials: 'MI',
    rating: 5,
    text: 'Ordered 60 matching costumes in bulk for our annual day. Great quality, consistent sizing, and delivered well before the event.',
  },
  {
    name: 'Rahul Mehta',
    initials: 'RM',
    rating: 4,
    text: 'Good collection and fair pricing on rentals. WhatsApp support was quick to respond to all my questions.',
  },
  {
    name: 'Nataraj Dance Academy',
    initials: 'ND',
    rating: 5,
    text: 'We buy our performance costumes in bulk every season now. Sadguru Costume always gets sizing and colors right across the whole group.',
  },
  {
    name: 'Sneha Patil',
    initials: 'SP',
    rating: 5,
    text: 'Rented traditional frocks for my twins — even better than the photos, and the return process was hassle-free.',
  },
  {
    name: 'Vikram Joshi, Event Organizer',
    initials: 'VJ',
    rating: 5,
    text: 'Placed a bulk order for a cultural fest with a tight deadline. They delivered on time with zero quality issues. Will order again.',
  },
]
